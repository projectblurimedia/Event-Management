...
import { eventTypes } from './modules/eventTypes/eventTypes.routes';
...
app.use('/api/event-types', eventTypes.publicRouter);
...
app.use('/api/admin/event-types', eventTypes.adminRouter);
