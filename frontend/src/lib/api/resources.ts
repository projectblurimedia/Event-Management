...
import type { Category, CategoryType, EventType, Item, Package, Testimonial } from '@/types/api';
...
export const eventTypeHooks = createResourceHooks<EventType>('event-types');
